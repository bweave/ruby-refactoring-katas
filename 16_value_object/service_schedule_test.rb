...
class ServiceScheduleTest < Minitest::Test
  ...
  def test_displays_pm_time
    schedule =
      ServiceSchedule.new([{ name: "Evening", day: "Sunday", time: "18:30", zone: NEW_YORK }])
  ...
  def test_displays_noon
    schedule =
      ServiceSchedule.new([{ name: "Noon", day: "Saturday", time: "12:00", zone: CHICAGO }])
  ...
  def test_displays_multiple_services
    ...
    assert_equal ["Traditional: Sunday 8:00 AM CT", "Contemporary: Sunday 10:30 AM CT"],
                 schedule.display
  end
